			...
			<input type="text" value="<?php echo base_url('quiz/'.$question_id);?>" readonly="" id="share-link"/>
						...
						<div class="custom-block">
			                ...
			                <div class="addthis_inline_share_toolbox" 
			                	...
			                	data-title="<?php echo $performer . ' - ' . $site->site_title;?>" 
			                	data-description="<?php echo $performer . trim($site->site_description);?>"
					...
					<div class="text-center">
						<a class="btn btn-warning btn-lg" href="<?php echo base_url('quiz/'.$question_id);?>">View Result</a>
					</div>
